package com.usatayamish.expertcourseunscramblegame.views.check
    ...
    constructor(superState: Parcelable) : super(superState)
      ...
      private constructor(parcelIn: Parcel) : super(parcelIn) {
       state = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
             parcelIn.readSerializable(CheckUiState::class.java.classLoader, CheckUiState::class.java) as CheckUiState
        } else {
